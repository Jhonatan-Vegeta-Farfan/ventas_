async function listar_personas() {
  try {
    let respuesta = await fetch(
      base_url + "controller/Persona.php?tipo=listar_p"
    );
...
async function registrarPersona() {
  ...
  try {
    ...
    let respuesta = await fetch(
      base_url + "controller/Persona.php?tipo=registrar",
      {
        //await es una promesa que si o si espera una respuesta
        method: "POST",
        mode: "cors",
        cache: "no-cache",
        body: datos,
...
async function ver_persona(id) {
  ...
  try {
    ...
    if (json.status) {
      ...
      document.querySelector("#nro_identidad").value =
        json.contenido.nro_identidad;
      document.querySelector("#razon_social").value =
        json.contenido.razon_social;
...
async function actualizarPersona() {
  ...
  try {
    let respuesta = await fetch(
      base_url + "controller/Persona.php?tipo=actualizar",
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
