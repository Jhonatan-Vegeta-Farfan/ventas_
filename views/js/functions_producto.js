async function listar_productos() {
  try {
    let respuesta = await fetch(
      base_url + "controller/Producto.php?tipo=listar"
    );
...
async function registrar_producto() {
  ...
  try {
    ...
    let respuesta = await fetch(
      base_url + "controller/Producto.php?tipo=registrar",
      {
...
async function listar_categorias() {
  try {
    let respuesta = await fetch(
      base_url + "controller/Categoria.php?tipo=listar"
    );
    json = await respuesta.json();
    if (json.status) {
      let datos = json.contenido;
...
async function listarProveedor() {
  try {
    let respuesta = await fetch(
      base_url + "controller/Persona.php?tipo=listar_proveedores"
    );
    json = await respuesta.json();
    if (json.status) {
      let datos = json.contenido;
...
async function actualizar_producto() {
  ...
  try {
    let respuesta = await fetch(
      base_url + "controller/Producto.php?tipo=actualizar",
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
