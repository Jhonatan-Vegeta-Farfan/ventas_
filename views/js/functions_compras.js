...
async function registrar_compra() {
  ...
  try {
    ...
    let respuesta = await fetch(
      base_url + "controller/Compra.php?tipo=registrar",
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
...
async function listar_trabajadores() {
  try {
    let respuesta = await fetch(
      base_url + "controller/Persona.php?tipo=listar_trabajador"
    );
    json = await respuesta.json();
    if (json.status) {
      let datos = json.contenido;
...
async function actualizarCompra() {
  ...
  try {
    let respuesta = await fetch(
      base_url + "controller/Compra.php?tipo=actualizar",
      {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
