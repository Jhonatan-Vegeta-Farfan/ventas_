            ...
            <div class="card-body">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="usuario" placeholder="Ingresa tu Correo" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo BASE_URL ?>suscribirte" class="btn btn-success">Registrarse</a>
                    </div>
                </form>
            </div>
        </div>
